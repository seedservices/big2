...
## Quick Start
1. Sign in (optional). If you don’t sign in, you can still play but your profile won’t sync.
...
## Scoring Guide
- Open `Scoring` from Home or in-game to see the full scoring rules:
  - Base multipliers by remaining cards
  - Penalties for holding `2` and `♠2`
  - Stacking multiplier behavior
...
- Save high cards to control late-round tempo.
