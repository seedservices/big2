...
function Pip-Layout([string]$rank){
  switch($rank){
    'A'  { @(@{x=0.5;y=0.50;i=$false;s=1.35}) }
    '2'  { @(@{x=0.5;y=0.30;i=$false},@{x=0.5;y=0.70;i=$true}) }
    '3'  { @(@{x=0.5;y=0.26;i=$false},@{x=0.5;y=0.50;i=$false},@{x=0.5;y=0.74;i=$true}) }
    '4'  { @(@{x=0.34;y=0.29;i=$false},@{x=0.66;y=0.29;i=$false},@{x=0.34;y=0.71;i=$true},@{x=0.66;y=0.71;i=$true}) }
    '5'  { @(@{x=0.34;y=0.29;i=$false},@{x=0.66;y=0.29;i=$false},@{x=0.5;y=0.50;i=$false},@{x=0.34;y=0.71;i=$true},@{x=0.66;y=0.71;i=$true}) }
    '6'  { @(@{x=0.34;y=0.24;i=$false},@{x=0.66;y=0.24;i=$false},@{x=0.34;y=0.50;i=$false},@{x=0.66;y=0.50;i=$false},@{x=0.34;y=0.76;i=$true},@{x=0.66;y=0.76;i=$true}) }
    '7'  { @(@{x=0.34;y=0.24;i=$false},@{x=0.66;y=0.24;i=$false},@{x=0.50;y=0.38;i=$false},@{x=0.34;y=0.50;i=$false},@{x=0.66;y=0.50;i=$false},@{x=0.34;y=0.76;i=$true},@{x=0.66;y=0.76;i=$true}) }
    '8'  { @(@{x=0.34;y=0.23;i=$false},@{x=0.66;y=0.23;i=$false},@{x=0.34;y=0.39;i=$false},@{x=0.66;y=0.39;i=$false},@{x=0.34;y=0.61;i=$true},@{x=0.66;y=0.61;i=$true},@{x=0.34;y=0.77;i=$true},@{x=0.66;y=0.77;i=$true}) }
    '9'  { @(@{x=0.34;y=0.22;i=$false},@{x=0.66;y=0.22;i=$false},@{x=0.34;y=0.38;i=$false},@{x=0.66;y=0.38;i=$false},@{x=0.50;y=0.50;i=$false},@{x=0.34;y=0.62;i=$true},@{x=0.66;y=0.62;i=$true},@{x=0.34;y=0.78;i=$true},@{x=0.66;y=0.78;i=$true}) }
...
foreach($suit in $suits){
  foreach($rank in $ranks){
    ...
    foreach($p in (Pip-Layout $rank)){
      $size = 114
      if($rank -eq 'A'){ $size = 162 }
      if($p.ContainsKey('s')){ $size = [int]($size * $p.s) }
