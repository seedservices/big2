...
function renderHome(){
  ...
  const roomStartControl=roomIsHost?`<button id="room-start" class="primary" ${roomStarting?'disabled':''}>${t('roomStart')}</button>`:(roomStarting?'':`<span class="hint">${t('roomReadyHint')}</span>`);
